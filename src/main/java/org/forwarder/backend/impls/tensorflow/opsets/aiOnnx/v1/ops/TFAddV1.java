...
public class TFAddV1 extends TFOperator implements AddV1<Tensor<?>> {

	@Override
	public Tensor<?> add(Tensor<?> a, Tensor<?> b, Long axis, Long broadcast, List<Long> consumedInputs) {
		...
		return Add.create(scope, TensorUtil.toConstant(scope, (Tensor<Number>) a), opTensorB).asOutput().tensor();
	}
